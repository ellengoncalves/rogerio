...
const produtos = [
  {
    ...
    descricao: "<b>Dados Animal</b> <br> Nome: Luck <br> Raça: Caramelo tradicional <br> Sexo: Macho<br><br> <b>Mais informações:</b> <br> Lucky tem porte médio, está castrado e vacinado. Foi resgatado de maus tratos, tem 1 ano <br><br> <b>Dados doador</b> <br> Nome: Leticia Feloni <br> Contato: (16) 99789-0905",
    tipo: "cachorro"
  },
  {
    ...
    titulo: "Snoop",
    raca: "SRD",
    descricao: "<b>Dados Animal</b> <br> Nome: Snoop <br> Raça: SRD <br> Sexo: Macho<br><br> <b>Mais informações:</b> <br> Foi resgatado das ruas. Hoje tem cerca de 3 anos, castrado, vacinado, vermifugado <br><br> <b>Dados doador</b> <br> Nome: Mary <br> Contato: (16) 99233-5115",
    tipo: "cachorro"
  },
  {
    ...
    titulo: "Tunico",
    raca: "SRD",
    descricao: "<b>Dados Animal</b> <br> Nome: Tunico <br> Raça: SRD <br> Sexo: Fêmea<br><br> <b>Mais informações:</b> <br> Foi resgatada do lixão, onde foi abandonada. Está em lar temporário pago. Tem cerca de 2 anos, castrada, vacinada e vermifugada <br><br> <b>Dados doador</b> <br> Nome: Mary <br> Contato: (16) 99233-5115",
    tipo: "cachorro"
  },
  {
    ...
    titulo: "Nina",
    raca: "SRD",
    descricao: "<b>Dados Animal</b> <br> Nome: Nina <br> Raça: SRD <br> Sexo: Fêmea<br><br> <b>Mais informações:</b> <br> É porte médio, está castrado e vacinado <br><br> <b>Dados doador</b> <br> Nome: Leticia Feloni <br> Contato: (16) 99789-0905",
    tipo: "cachorro"
  },
  {
    ...
    titulo: "Bob",
    raca: "SRD",
    descricao: "<b>Dados Animal</b> <br> Nome: Bob <br> Raça: SRD <br> Sexo: Macho<br><br> <b>Mais informações:</b> <br> Castrado, vacinado e adestrado <br> <b>Adoção especial:</b> <br> Pessoas que tenham liderança e gostem de caminhar ou correr <br><br> <b>Dados doador</b> <br> Nome: Leticia Feloni <br> Contato: (16) 99789-0905",
    tipo: "cachorro"
  },
  {
  ...
  },
  {
    ...
    titulo: "Maurício",
    raca: "SRD",
    descricao: "<b>Dados Animal</b> <br> Nome: Maurício <br> Sexo: Macho <br> Raça: SRD <br><br><br> <b>Mais informações:</b> <br> 9 meses de vida. São castrado, e vacinado com a 1° dose da vacina! São negativados para Fiv e Felv <br><br> <b>Dados doador</b> <br> Nome: Kassia Brito <br> Contato: (16) 99787-5528",
    tipo: "gato"
  },
  {
    ...
    raca: "SRD",
    descricao: "<b>Dados Animal</b> <br> Nome: Não possui (filhote) <br> Raça: SRD <br> Sexo: Macho<br><br> <b>Dados doador</b> <br> Nome: Marlucia Ramos <br> Contato: (16) 99742-1161",
    tipo: "gato"
  },
  {
    ...
    titulo: "Branquinha",
    raca: "SRD",
    descricao: "<b>Dados Animal</b> <br> Nome: Branquinha <br> Raça: SRD <br> Sexo: Fêmea<br><br> <b>Mais informações:</b> <br> A branquinha positivou para FIV – Vírus da imunodeficiência felina (AIDS Felina)</b> <br> Nome: Ana Larissa <br> Contato: (16) 99764-8770",
    tipo: "gato"
  },
  {
    ...
    raca: "SRD",
    descricao: "<b>Dados Animal</b> <br> Nome: Não possui nome <br> Raça: Não identificado/Vira-Lata <br> Sexo: Fêmea<br><br> <b>Mais informações: Ela possui uma irmã e a preferência é que se adote ambas pois são muito apegadas</b> <br> Ela</b> <br> Nome: Giovana Real <br> Contato: (16) 99789-0905",
    tipo: "gato"
  },
  {
  ...
  },
  {
    ...
    titulo: "Não possui nome (filhote)",
    raca: "SRD",
    descricao: "<b>Dados Animal</b> <br> Nome: Não possui nome (filhote) <br> Raça: SRD <br> Sexo: fêmea<br><br> <b>Mais informações:</b> <br> Têm 3 meses, está castrada, vermifugada e sem pulgas. <br><br> <b>Dados doador</b> <br> Nome: Castração Felina Araraquara <br> Contato: (16) 99601-6585",
    tipo: "gato"
  }
];
...
tipoAnimal.addEventListener("change", () => {
  ...
  for (let i = 0; i < itens.length; i++) {
    const tipoAnimalCard = itens[i].querySelector(".tipo-animal").textContent.toLocaleLowerCase();
    const itemDiv = itens[i];
    
    if(tipo != 'todos') {
      if (tipoAnimalCard == tipo) {
...
function buscaItem() {
  ...
  for (let i = 0; i < itens.length; i++) {
    ...
    if(tipo != 'todos') {
      if ((titulo.includes(valor) || raca.includes(valor)) && tipoAnimalCard == tipo ) {
        itemDiv.style.display = "block";
      } else {
        itemDiv.style.display = "none";
      }
...
function criarGaleria() {
  ...
  for (let i = 0; i < numeroItens; i++) {
    ...
    tipo.classList.add("tipo-animal");
    tipo.textContent = produtos[i].tipo;
